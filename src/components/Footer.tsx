...
const Footer: React.FC = () => {
  const navigation = {
    ...
    social: [
      ...
      {
        name: 'LinkedIn',
        href: 'https://linkedin.com/in/chhedadhruv',
        icon: (props: React.SVGProps<SVGSVGElement>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        <div className="grid grid-cols-1 lg-grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="https://github.com/chhedadhruv/create-projex/issues"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://github.com/chhedadhruv/create-projex/blob/main/CONTRIBUTING.md"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition-colors"
                >
              ...
              <li>
                <a
                  href="https://github.com/chhedadhruv/create-projex/releases"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition-colors"
                >
